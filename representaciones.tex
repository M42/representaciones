...
\begin{proof}
  ...
  homeomorfismo entre $SO(3)$ y $\mathbb{RP}^3$. $\qed$
\end{proof}
...
De este resultado se deduce que $SO(3)$ es conexo y que tiene un grupo
fundamental no trivial, no siendo, por tanto, simplemente conexo.
