...
\begin{proposition}
  El grupo $SO(3)$, con la topología dada por (?) es homeomorfo al
  espacio proyectivo tridimensional $\mathbb{RP}^3$.
\end{proposition}
\begin{proof}
...
el isomorfismo entre los dos espacios, que de hecho es un difeomorfismo, sin más que considerar el difeomorfismo entre $M_2(\mathbb C)$ y $R^8$ y restringir.
