...
\begin{theorem}
  \textbf{Fórmula de Rodrigues.} Si llamamos $\mathbf{R}_{\alpha,a}$ a la rotación de ángulo
  $\alpha$ sobre el eje dado por un vector no nulo $a$, la
  ecuación
...
\[
  ...
  \qquad
  q_c = \cos \frac{1}{2} \gamma + b \sin \frac{1}{2} \gamma.
\]
entonces el desarrollo del producto acaba resultando en la fórmula
de Rodrigues con la misma solución
\[\begin{aligned}
    \cos \frac{1}{2}\gamma &=
    \cos \frac{1}{2}\alpha \cos\frac{1}{2}\beta - \sin\frac{1}{2}\alpha\sin\frac{1}{2}\beta (a\cdot b)\\
    \sin \frac{1}{2}\gamma n &=
