...
\begin{proofname}\\
%	Sea $ M \in SO(3)$ una rotación. Queremos ver que la matriz tiene al menos un vector propio.
%	Consideramos $p(\lambda) = det(M - \lambda I_3)$ el polinomio característico de $M$. Por ser
%	de grado 3, tiene al menos una solución en $\mathbb R$, a la que llamamos $\lambda_1$
\end{proofname}
